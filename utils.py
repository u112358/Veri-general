...
def conv_normalization_layer(batch_data, name, train=tf.constant(True, tf.bool), beta=None, eps=None):
    """
    :param batch_data:
    :param train:
    :param beta:
    ...
    with tf.variable_scope(name):
        ...
        normed = tf.nn.batch_normalization(batch_data, mean, var, beta, eps, 1e-3)
    return normed
